...
const Footer = () => {
  return (
    <footer className="bg-gradient-to-t from-sky-900 to-sky-950 text-white py-8">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center text-center mx-24">
          <div className="flex flex-wrap justify-center gap-6 mb-4 md:mb-0">
            ...
            <a href="#testimonials" className="hover:text-sky-300 transition-colors">
              Testimonials
            </a>
          ...
          <div className="flex space-x-4">
            <a href="https://www.facebook.com/?locale=fr_FR" className="hover:text-sky-300 transition-colors">
            ...
            <a href="https://www.twitter.com/" className="hover:text-sky-300 transition-colors">
            ...
            <a href="https://www.instagram.com/" className="hover:text-sky-300 transition-colors">
        ...
        <div className="mt-8 pt-6 border-t border-sky-800 text-center text-sky-300 text-sm">
          <p>
            &copy; {new Date().getFullYear()} FireGuard | All rights reserved.
          </p>
        </div>
      </div>
    </footer>
