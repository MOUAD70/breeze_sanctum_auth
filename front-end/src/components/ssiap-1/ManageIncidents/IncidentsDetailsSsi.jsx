...
import {
  SSIAP_1_ADD_INCIDENTS_ROUTE,
  SSIAP_1_EDIT_INCIDENTS_ROUTE,
} from "../../../routes";
import { Link } from "react-router-dom";

const IncidentsDetailsSsi = () => {
  ...
  const filteredIncidents = incidents.filter((incident) => {
    if (user?.site_id !== incident.site_id) return false;
    ...
    <div className="max-w-7xl mx-auto space-y-6">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
        ...
        <div className="flex justify-end mx-6 mt-4">
          <Link
            to={SSIAP_1_ADD_INCIDENTS_ROUTE}
          ...
          {loading ? (
            ...
            <div className="text-center py-6">
              ...
              <Button
                ...
                onClick={() => navigate(SSIAP_1_ADD_INCIDENTS_ROUTE)}
              >
                <Plus className="h-4 w-4 mr-2" /> Report an Incident
              </Button>
            </div>
          ) : (
            <div className="space-y-4">
                ...
                >
                  <div className="flex items-start justify-between">
                    ...
                    {canModifyIncident(incident) && (
                      <div className="flex">
                        <Link
                          to={SSIAP_1_EDIT_INCIDENTS_ROUTE.replace(
                            ":id",
                            incident.id
                          )}
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
        <div className="bg-gradient-to-r from-sky-50 to-white p-6 border-b border-gray-100">
          <div className="flex flex-col items-center justify-center">
            ...
            <p className="text-gray-600 text-sm mt-3">
              View all security incidents at your site
            </p>
          </div>
        </div>
...
export default IncidentsDetailsSsi;
