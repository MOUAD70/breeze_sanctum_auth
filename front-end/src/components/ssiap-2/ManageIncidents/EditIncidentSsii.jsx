...
import { ArrowLeft, Loader2, AlertTriangle, MapPin, AlertCircle } from "lucide-react";
  ...
  useEffect(() => {
    const fetchIncident = async () => {
      try {
        ...
        // Check if user can edit this incident (SSIAP-2 can edit incidents from their site)
        if (incident.site_id !== user.site_id) {
...
export default EditIncidentSsii;
