...
import { SSIAP_3_INCIDENTS_ROUTE } from "../../../routes";
import { Skeleton } from "@/components/ui/skeleton";

const EditIncidentSsiii = () => {
  const { id } = useParams();
  ...
  const handleSelectChange = (name, value) => {
    if (name === "location") {
      // Find the site id that matches the selected site name
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      navigate(SSIAP_3_INCIDENTS_ROUTE);
    } catch (err) {
...
export default EditIncidentSsiii;