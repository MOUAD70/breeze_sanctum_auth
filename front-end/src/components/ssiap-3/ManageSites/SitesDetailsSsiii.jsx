...
import {
  SSIAP_3_ADD_SITE_ROUTE,
  SSIAP_3_EDIT_SITE_ROUTE,
} from "../../../routes";

const SitesDetailsSsiii = () => {
                    ...
                    >
                      <div className="flex items-start justify-between">
                        ...
                        <div className="flex space-x-1">
                          <Link
                            to={SSIAP_3_EDIT_SITE_ROUTE.replace(":id", site.id)}
...
export default SitesDetailsSsiii;